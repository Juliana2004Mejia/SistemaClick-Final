    ...
    public class TipoDocumentosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TipoDocumentos != null ? 
                          ...
                          Problem("Entity set 'DataContext.TipoDocumentos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataContext.TipoDocumentos'  is null.");
            }
            var tipoDocumento = await _context.TipoDocumentos.FindAsync(id);
            if (tipoDocumento != null)
            {
        ...
        {
          return (_context.TipoDocumentos?.Any(e => e.TipoDocumentoId == id)).GetValueOrDefault();
        }
    }
}
