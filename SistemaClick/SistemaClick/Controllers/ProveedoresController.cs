    ...
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedores != null ? 
                          ...
                          Problem("Entity set 'DataContext.Proveedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,Nombre,Apellido,Tipo_persona,Direccion,Email,Telefono,Nombre_producto")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,Nombre,Apellido,Tipo_persona,Direccion,Email,Telefono,Nombre_producto")] Proveedor proveedor)
        {
